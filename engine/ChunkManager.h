...
public:
  ...
  void Set(const glm::ivec3& coord, const glm::ivec3& position, Voxel* data);
  ...
  void GreedyMesh(const glm::ivec3& coord, const glm::ivec3& offset, const std::vector<Material>& materials, std::vector<Vertex>& out);
